...
class XKubernetesPodOperatorException(Exception):
    pass

class XKubernetesPodOperator(BaseOperator):
    """
    ...
    def execute(self, context):
        try:
            ...
            raise XKubernetesPodOperatorException("Could not start off with Dag Run Configuration",e)
        try:
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(XKubernetesPodOperator, self).__init__(*args, **kwargs)
        self.image = image
